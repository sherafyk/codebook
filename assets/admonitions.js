const icons = {
  ...
  caution: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20"><polygon points="10,3 19,17 1,17" fill="#FEF9C3" stroke="#FACC15" stroke-width="2"/><text x="10" y="16" text-anchor="middle" font-size="12" fill="#FACC15" font-family="Arial" font-weight="bold">!</text></svg>`,
